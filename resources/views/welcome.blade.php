        ...
        <form class="form-group" method="POST" action="{{ route('newTimeDeposit') }}" accept-charset="UTF-8"  enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                <div class="form-group">
                    ...
                    <br/>
                    <label class="form-control-label">Días
                        <input type="number" name="days" min="30" placeholder="Días de duración depósito"
                               value="{{ old('days') }}">
                    </label>
                    <br/>
                    ...
                    <br/>
                    <input class="btn btn-primary btn-block" type="submit" value="Calcular">
                </div>
            </div>
        </form>
    </div>
